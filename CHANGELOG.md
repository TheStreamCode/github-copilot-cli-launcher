...
- Removed duplicate command send that caused Copilot CLI to consume two premium requests on every launch. The command is now sent exactly once through shell integration or the fallback path.
